...
<body style="background-color:#EEEEEE;">
  ...
  <input type="text" name="search" class="form-control shadow-none" style="border:none;" placeholder="Search blog in <?php echo $category_title ?>">
  ...
  <div  class="container-fluid text-center" style=" background-color:#EEEEEE;padding:40px;margin-bottom:0px;">
       <h5 class="text-uppercase" style="text-align:center;color:#808080"><?php echo $category_title; ?></h5>
       <div class="content">
...
echo "</div><br><h6 class='text-uppercase' style='text-align:center;color:#808080'>No blog found for this category !!</h6>";
              }
